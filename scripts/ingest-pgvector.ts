...
async function main() {
  ...
  console.log(`Upserting ${documents.length} documents to Supabase...`);

  // Upsert in batches of 50 (pgvector rows are larger)
  const BATCH_SIZE = 50;
  let upserted = 0;
  ...
  console.log("Done! Supabase pgvector ingestion complete.");
